...
Для обучения модели необходимо было выполнить в терминале команду
python train.py --img 960 --batch 16 --epochs 50 --data ./data/helmet.yaml --weights yolov5s.pt

Для тестирвония модели:
python detect.py --weights runs/train/exp5/weights/best.pt --img 960 --conf 0.5 --source C:\Users\Admin\PycharmProjects\helmet_detection_project\combined_dataset\images\test
